...
async def create_volume(
    ...
    try:
        ...
        _ = await operation_task_service.update_task(task.id, state="succeeded", target_id=response.id)
...
async def delete_volume(
    ...
    try:
        ...
        _ = await operation_task_service.update_task(task.id, state="succeeded", target_id=volume_id)
    except Exception as exc:
        _ = await operation_task_service.update_task(task.id, state="failed", target_id=volume_id, error_message=str(exc))
        raise
