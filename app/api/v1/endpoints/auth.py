...
def auth_config(auth_service: Annotated[AuthService, Depends(get_auth_service)]) -> OpenStackTokenInfo:
...
def openstack_session(auth_service: Annotated[AuthService, Depends(get_auth_service)]) -> OpenStackValidationResponse:
