...
ENDPOINTS = [
    ...
    {"method": "GET", "path": "/api/v1/vmware/vms", "name": "List VMware VMs", "enabled": True},
    {"method": "GET", "path": "/api/v1/vmware/datastores", "name": "List VMware Datastores", "enabled": True},
    {"method": "GET", "path": "/api/v1/vmware/networks", "name": "List VMware Networks", "enabled": True},
]
